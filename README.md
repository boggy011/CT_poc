...
and the status labels live in `src/retpack_ui/theme.py`. `assets/logo.png` is the AB InBev wordmark (shown on a white
plate in the dark sidebar), `assets/logo_icon.png` the leaf mark used as the browser-tab icon.
